...
DESCRIPTION:Cérémonie civile à 11h à la Mairie de Clichy-la-Garenne, puis réception au Splash.
LOCATION:Mairie de Clichy-la-Garenne, 80 Boulevard Jean Jaurès, 92110 Clichy-la-Garenne
END:VEVENT
END:VCALENDAR`
              ...
              <div className="hero-content">
                ...
                <div className="hero-details">
                  ...
                  <div className="hero-detail-item">
                    ...
                    <p>Hôtel de Ville de Clichy-la-Garenne</p>
                  </div>
                </div>
